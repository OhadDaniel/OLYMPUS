...
// Exact lucide paths used in the style guide, inlined for fidelity + zero dep risk.
const PATHS: Record<GodDesign["icon"], ReactNode> = {
  crown: (
    <>
...
export function GodIcon({ icon, color, size = 20 }: { icon: GodDesign["icon"]; color: string; size?: number }) {
  return (
